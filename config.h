...
/* Define to 1 if you have the `aacs' library (-laacs). */
/* #undef HAVE_LIBAACS */

/* Define to 1 if you have the `bdplus' library (-lbdplus). */
/* #undef HAVE_LIBBDPLUS */
...
#define PACKAGE_BUGREPORT "http://bd.videolan.org/"

/* Define to the full name of this package. */
#define PACKAGE_NAME "libbluray"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "libbluray 0.2"
